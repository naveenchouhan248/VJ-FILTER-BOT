...
API_ID = int(environ.get('API_ID', '7030454'))
API_HASH = environ.get('API_HASH', '267b22b5ecf0429f99701b7b0259b96b')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '622731652').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001166312945').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://megacollection248:Mongo@786@cluster0.8i0jf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
